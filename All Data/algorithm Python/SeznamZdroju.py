...
class SeznamZdroju():
    ...
    def vratSeznamAdresZdroju(self):
        ...
        #seznamZdroju = []
        adresaNadrazeneSlozky = 'C:\\Users\\jonas\\PycharmProjects\\DokumentaceJAVY\\Kod JAVY\\src\\'
...
class vykonavaniHlavnihoProgramu():
    ...
    def hlavniProgram(self):
        ...
        for i in range(0, pocetSouboru):
            ...
            startProgramu = NactiZdroj.NactiDataProJedenZdroj()
        ...
        novyJAVAKod3 = NovyJAVAKod.RoztahujData(dataVsechSouboru)
        novyJAVAKod3.hlavni()
