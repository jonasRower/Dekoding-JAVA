    ...
    def hlavniProgram(self):
        ...
        for i in range(0, pocetSouboru):
            ...
            # data pro jeden soubor ulozi sem
              <a href="../../../mainProgram/SeznamZdroju/class_vykonavaniHlavnihoProgramu()/def_hlavniProgram(self).md">dataJednohoSouboru=startProgramu.spustProgram(adresaZdroj,zdroj)</a>
