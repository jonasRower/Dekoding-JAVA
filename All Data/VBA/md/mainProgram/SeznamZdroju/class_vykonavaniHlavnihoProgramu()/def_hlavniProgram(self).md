...
```
              [link](../../../../../../All%20Data/VBA/md/mainProgram/SeznamZdroju/class_vykonavaniHlavnihoProgramu()/def_doplnVolanouTriduKeKonstruktoru(self,_dataJednohoSouboru).md)  
```
...
```
              [link](../../../../../../All%20Data/VBA/md/mainProgram/SeznamZdroju/class_vykonavaniHlavnihoProgramu()/def_kVolaneMetodeNajdiNazevTridy(self,_dataJednohoSouboru,_dataVsechSouboru).md)  
```
...
```
          [link](../../../../../../All%20Data/VBA/md/mainProgram/NovyJAVAKod/class_RoztahujData()/def_kVolaneMetodeNajdiNazevTridy(self,_dataJednohoSouboru,_dataVsechSouboru).md)  
```
...
```
        novyJAVAKod.hlavni()
```
          [link](../../../../../../All%20Data/VBA/md/mainProgram/NovyJAVAKod2/class_RoztahujData()/def_hlavni(self).md)  
```
