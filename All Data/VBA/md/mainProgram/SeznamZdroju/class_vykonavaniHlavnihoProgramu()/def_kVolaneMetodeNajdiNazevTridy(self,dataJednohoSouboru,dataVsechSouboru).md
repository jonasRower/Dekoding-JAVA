 ...
 <code>
    def kVolaneMetodeNajdiNazevTridy(self, dataJednohoSouboru, dataVsechSouboru):
        ...
        nazevTridy = dataJednohoSouboru.nazevSouboru
          <a href="../../../../../../All%20Data/VBA/md/mainProgram\SeznamZdroju\class_vykonavaniHlavnihoProgramu()\def vratIndexDatDanehoSouboru(self, pozadovanaTrida, dataVsechSouboru)">IndexZapisDat=self.vratIndexDatDanehoSouboru(nazevTridy,dataVsechSouboru)</a>
            ...
            if(nazevMetodyHodnota != ""):
                ...
                if(nazevInstance == ""):
                    ...
                    if(nazevInstance == "_"):   #"_"
                        ...
                        nazevTridy = dataJednohoSouboru.volanaTrida[i]
                          ...
                          <a href="../../../../../../All%20Data/VBA/md/mainProgram\SeznamZdroju\class_vykonavaniHlavnihoProgramu()\def dohledejNazevTridyKInstanci(self, dataJednohoSouboru, pozadovanaInstance, hledejDoRadku, nazevTridyOrig)">nazevTridy=self.dohledejNazevTridyKInstanci(dataJednohoSouboru,nazevInstance,i,nazevTridy)</a>

                      <a href="../../../../../../All%20Data/VBA/md/mainProgram\SeznamZdroju\class_vykonavaniHlavnihoProgramu()\def vratIndexDatDanehoSouboru(self, pozadovanaTrida, dataVsechSouboru)">hledanyIndex=self.vratIndexDatDanehoSouboru(nazevTridy,dataVsechSouboru)</a>
                    if (hledanyIndex > -1):
                ...
                if (zapisujData == True):
                    ...
                    # pokud je instance = "" pak se vyhledava v datech stejne tridy jako volana metoda
                      <a href="../../../../../../All%20Data/VBA/md/mainProgram\SeznamZdroju\class_vykonavaniHlavnihoProgramu()\def dohledejCisloRadkuKDaneMetode(self, hledanaMetoda, nazvyMetod)">cisloRadkuMetody=self.dohledejCisloRadkuKDaneMetode(nazevMetodyHodnota,nazvyMetod)</a>

                    if (cisloRadkuMetody > -1):
                        # Vyhleda index nejblizsi otevrene a zavrene zavorky
                          <a href="../../../../../../All%20Data/VBA/md/mainProgram\Metody\class_OstatniMetody()\def vratNejblizsiRadekSOtevrenouZavorkou(self, fromIndex, dataSlozenaZavorka)">indexNejblizsiOtevreneZavorky=ostatniMetody.vratNejblizsiRadekSOtevrenouZavorkou(cisloRadkuMetody,slozeneZavorky)</a>
                          <a href="../../../../../../All%20Data/VBA/md/mainProgram\Metody\class_OstatniMetody()\def vratCisloRadkuSKoncemBloku(self, fromIndex, dataSlozenaZavorka)">indexNejblizsiZavreneZavorky=ostatniMetody.vratCisloRadkuSKoncemBloku(indexNejblizsiOtevreneZavorky,slozeneZavorky)</a>
