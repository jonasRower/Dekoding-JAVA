 ...
 <code>
    def vratNazevMetody(self, radekKodu):
        ...
        # kod vykonava na zaklade zjisteni existence zavorek "(" a ")"
          <a href="../../../../../../All%20Data/VBA/md/mainProgram\Metody\class_MetodyJednohoRadku()\def __InjectedObj(self)">jednaSeOMetodu=self.__InjectedObj().indikujZdaSeJednaOMetodu(radekKodu)</a>
