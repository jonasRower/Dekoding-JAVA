...
```
### links
[jednaSeOMetodu=self.__InjectedObj().indikujZdaSeJednaOMetodu(radekKodu)](../../../../../../All%20Data/VBA/md/mainProgram/Metody/class_MetodyJednohoRadku()/def___InjectedObj(self).md)  
