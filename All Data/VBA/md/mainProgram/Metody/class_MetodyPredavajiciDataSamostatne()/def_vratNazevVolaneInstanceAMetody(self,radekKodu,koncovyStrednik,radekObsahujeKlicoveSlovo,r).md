        ...
        if (koncovyStrednik == True):
            ...
            if (radekObsahujeKlicoveSlovo == False):
                ...
                # kod vykonava na zaklade zjisteni existence zavorek "(" a ")"
                  <a href="../../../../../../All%20Data/VBA/md/mainProgram/Metody/class_MetodyPredavajiciDataSamostatne()/def___InjectedObj(self).md">jednaSeOMetodu=self.__InjectedObj().indikujZdaSeJednaOMetodu(radekKodu)</a>
                ...
                if (jednaSeOMetodu == True):
                    ...
                    if (len(InstanceAMetodaArr) == 2):
                        ...
                        volanaMetoda = InstanceAMetodaArr[1]
                          ...
                          <a href="../../../../../../All%20Data/VBA/md/mainProgram/Metody/class_MetodyPredavajiciDataSamostatne()/def___InjectedObj(self).md">jeInstanceKlicoveSlovo=self.__InjectedObj().detekujPritomnostKlicovehoSlova(volanaInstance)</a>
                          <a href="../../../../../../All%20Data/VBA/md/mainProgram/Metody/class_MetodyPredavajiciDataSamostatne()/def___InjectedObj(self).md">jeMetodaKlicoveSlovo=self.__InjectedObj().detekujPritomnostKlicovehoSlova(volanaMetoda)</a>
          ...
          <a href="../../../../../../All%20Data/VBA/md/mainProgram/Metody/class_MetodyPredavajiciDataSamostatne()/def___InjectedObj(self).md">self.__data.add_volanaInstance(volanaInstance)</a>
          <a href="../../../../../../All%20Data/VBA/md/mainProgram/Metody/class_MetodyPredavajiciDataSamostatne()/def___InjectedObj(self).md">self.__data.add_volanaMetoda(volanaMetoda)</a>
 <code>
<pre>
