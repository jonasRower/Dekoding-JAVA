        ...
        if (koncovyStrednik == True):
            if (klicoveSlovo == False):
                ...
                # potvrdi zda radek neobsahuje klicove slovo "new"
                  <a href="../../../../../../All%20Data/VBA/md/mainProgram\Metody\class_MetodyPredavajiciDataSamostatne()\def __InjectedObj(self)">radekObsaheujeNew=self.__InjectedObj().obahujeRadekKoduKlicoveSlovoNew(radekKodu)</a>

                if (radekObsaheujeNew == True):
                    # pak zapise konstruktor
                      <a href="../../../../../../All%20Data/VBA/md/mainProgram\Metody\class_MetodyPredavajiciDataSamostatne()\def zapisMetoduJakoKonstruktor(self, radekKodu, r)">self.zapisMetoduJakoKonstruktor(radekKodu,r)</a>
                else:
