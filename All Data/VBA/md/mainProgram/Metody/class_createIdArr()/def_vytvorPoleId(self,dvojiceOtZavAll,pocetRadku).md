    ...
    def vytvorPoleId(self, dvojiceOtZavAll, pocetRadku):
        ...
        for i in range(0, len(dvojiceOtZavAll)):
            ...
            doInd = dvojiceOtZavAll[i][1]
              ...
              <a href="../../../../../../All%20Data/VBA/md/mainProgram/Metody/class_createIdArr()/def_vratPoleIdDleOdDo(self, poleId, odInd, doInd).md">poleId=self.vratPoleIdDleOdDo(poleId,odInd,doInd)</a>
