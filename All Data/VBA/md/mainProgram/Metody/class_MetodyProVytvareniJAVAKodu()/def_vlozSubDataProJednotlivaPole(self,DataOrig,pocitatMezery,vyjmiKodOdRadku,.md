    ...
    def vlozSubDataProJednotlivaPole(self, DataOrig, pocitatMezery, vyjmiKodOdRadku,
        ...
        if (vyjmiKodOdRadku > -1):
            ...
            # prepise prazdne hodnoty hodnotami pozadovanymi
              <a href="../../../../../../All%20Data/VBA/md/mainProgram\Metody\class_MetodyProVytvareniJAVAKodu()\def prepisPolozkySubKodu(self, dataPole, hodnota)">dataNovy=self.prepisPolozkySubKodu(dataNovy,pozadovanaHodnota)</a>
