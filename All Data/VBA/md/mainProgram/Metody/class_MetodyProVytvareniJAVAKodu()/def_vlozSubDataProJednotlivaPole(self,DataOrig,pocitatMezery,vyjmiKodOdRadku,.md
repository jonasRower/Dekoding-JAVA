...
```
### links
[dataNovy=self.prepisPolozkySubKodu(dataNovy,pozadovanaHodnota)](../../../../../../All%20Data/VBA/md/mainProgram/Metody/class_MetodyProVytvareniJAVAKodu()/def_prepisPolozkySubKodu(self,_dataPole,_hodnota).md)  
