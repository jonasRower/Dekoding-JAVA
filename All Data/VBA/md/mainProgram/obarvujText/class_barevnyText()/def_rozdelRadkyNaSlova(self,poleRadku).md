    ...
    def rozdelRadkyNaSlova(self, poleRadku):
        ...
        for i in range(0, len(poleRadku)):
            ...
            radekSpl = radek.split(' ')
              <a href="../../../../../../All%20Data/VBA/md/mainProgram/obarvujText/def___init__(self,_dataDaneTridy,_ostatniMetody,_poleRadkuNOdDo)/radekSlova = [].md">radekSlova=self.vratRadekJenSlova(radekSpl)</a>
