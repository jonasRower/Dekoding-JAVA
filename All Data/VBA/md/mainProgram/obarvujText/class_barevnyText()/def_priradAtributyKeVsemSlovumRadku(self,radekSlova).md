    ...
    def priradAtributyKeVsemSlovumRadku(self, radekSlova):
        ...
        for i in range(0, len(radekSlova)):
            ...
            if(nazevAtributu == ""):
                  ...
                  <a href="../../../../../../All%20Data/VBA/md/mainProgram\obarvujText\def___init__(self,_dataDaneTridy,_ostatniMetody,_poleRadkuNOdDo)\try">slovoPredZavorkou=self.odeberZeSlovaObsahZavorky(slovo)</a>
