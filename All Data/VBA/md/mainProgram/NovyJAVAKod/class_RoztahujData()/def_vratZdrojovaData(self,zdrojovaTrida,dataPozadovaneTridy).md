    ...
    def vratZdrojovaData(self, zdrojovaTrida, dataPozadovaneTridy):
        if (zdrojovaTrida == ""):
            ...
            nazevSouboru = zdrojovaTrida + ".java"
              <a href="../../../../../../All%20Data/VBA/md/mainProgram/NovyJAVAKod/class_RoztahujData()/def_najdiDataPrislusneTridy2(self,pozadovanyNazevSouboru).md">dataZdrojoveTridy=self.najdiDataPrislusneTridy2(nazevSouboru)</a>
