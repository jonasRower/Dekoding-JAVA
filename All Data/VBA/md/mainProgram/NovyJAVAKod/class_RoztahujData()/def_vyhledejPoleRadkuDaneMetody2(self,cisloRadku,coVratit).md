    ...
    def vyhledejPoleRadkuDaneMetody2(self, cisloRadku, coVratit):
        ...
        if(nazevTridy == ""):
            ...
            nazevSouboru = nazevTridy + ".java"
              <a href="../../../../../../All%20Data/VBA/md/mainProgram/NovyJAVAKod/class_RoztahujData()/def_najdiDataPrislusneTridy(self,pozadovanyNazevSouboru,dataZdrojoveTridy).md">dataDaneTridy=self.najdiDataPrislusneTridy(nazevSouboru)</a>
            if (coVratit == "poleRadku"):
